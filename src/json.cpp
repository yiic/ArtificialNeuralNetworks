...
bool JsonListIterator::currentBool()
{
	return current()->asBool();
}

long long JsonListIterator::currentInt()
{
	return current()->asInt();
}

double JsonListIterator::currentDouble()
{
	return current()->asDouble();
}

const char* JsonListIterator::currentString()
{
...
JsonNode* JsonNode::getIfExists(const char* szName) const
{
	if(m_type != type_obj)
...
JsonNode* JsonNode::add(Json* pDoc, const char* szName, JsonNode* pNode)
{
	if(m_type != type_obj)
		throw Ex("\"", to_str(this), "\" is not an obj");
...
JsonNode* JsonNode::add(Json* pDoc, const char* szName, bool b)
{
	return add(pDoc, szName, pDoc->newBool(b));
}

JsonNode* JsonNode::add(Json* pDoc, const char* szName, long long n)
{
	return add(pDoc, szName, pDoc->newInt(n));
}

JsonNode* JsonNode::add(Json* pDoc, const char* szName, size_t n)
{
	return add(pDoc, szName, pDoc->newInt((long long)n));
}

JsonNode* JsonNode::add(Json* pDoc, const char* szName, double d)
{
	return add(pDoc, szName, pDoc->newDouble(d));
}

JsonNode* JsonNode::add(Json* pDoc, const char* szName, const char* str)
{
	return add(pDoc, szName, pDoc->newString(str));
}

JsonNode* JsonNode::add(Json* pDoc, JsonNode* pNode)
{
	if(m_type != type_list)
...
JsonNode* JsonNode::add(Json* pDoc, bool b)
{
	return add(pDoc, pDoc->newBool(b));
}

JsonNode* JsonNode::add(Json* pDoc, long long n)
{
	return add(pDoc, pDoc->newInt(n));
}

JsonNode* JsonNode::add(Json* pDoc, size_t n)
{
	return add(pDoc, pDoc->newInt((long long)n));
}

JsonNode* JsonNode::add(Json* pDoc, double d)
{
	return add(pDoc, pDoc->newDouble(d));
}

JsonNode* JsonNode::add(Json* pDoc, const char* str)
{
